...
* [SimpleITK](https://github.com/SimpleITK/SimpleITK) ⭐ 1,082 | 🐛 105 | 🌐 C++ | 📅 2026-08-26 - A simplified interface for the Insight Toolkit [ITK](https://itk.org/) with several components supporting general filtering operations, image segmentation, and registration.
...
* [dcm2niix](https://github.com/rordenlab/dcm2niix) ⭐ 1,182 | 🐛 3 | 🌐 C++ | 📅 2026-08-25 - Convert neuroimaging data from the DICOM format to the [NIfTI](https://nifti.nimh.nih.gov/) format.
...
* [VolView](https://github.com/Kitware/VolView) ⭐ 297 | 🐛 89 | 🌐 TypeScript | 📅 2026-08-18 - Web based radiological viewer for clinical professionals. Built with [Vue.js](https://vuejs.org/) and [VTK.js](https://github.com/Kitware/vtk-js) ⭐ 1,523 | 🐛 294 | 🌐 JavaScript | 📅 2026-08-21.
...
* [pydicom](https://github.com/pydicom/pydicom) ⭐ 2,197 | 🐛 40 | 🌐 Python | 📅 2026-08-03 - A pure Python package for working with DICOM files. It lets you read, modify and write DICOM data in an easy "pythonic" way.
