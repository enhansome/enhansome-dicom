...
* [SimpleITK](https://github.com/SimpleITK/SimpleITK) ⭐ 1,082 | 🐛 104 | 🌐 C++ | 📅 2026-08-27 - A simplified interface for the Insight Toolkit [ITK](https://itk.org/) with several components supporting general filtering operations, image segmentation, and registration.
...
* [VolView](https://github.com/Kitware/VolView) ⭐ 297 | 🐛 89 | 🌐 TypeScript | 📅 2026-08-18 - Web based radiological viewer for clinical professionals. Built with [Vue.js](https://vuejs.org/) and [VTK.js](https://github.com/Kitware/vtk-js) ⭐ 1,524 | 🐛 292 | 🌐 JavaScript | 📅 2026-08-27.
...
* [pydicom](https://github.com/pydicom/pydicom) ⭐ 2,198 | 🐛 40 | 🌐 Python | 📅 2026-08-03 - A pure Python package for working with DICOM files. It lets you read, modify and write DICOM data in an easy "pythonic" way.
...
* [DICOM-rs](https://github.com/Enet4/dicom-rs) ⭐ 557 | 🐛 77 | 🌐 Rust | 📅 2026-08-24 - A pure Rust implementation of the DICOM standard, allowing users to work with DICOM objects and interact with DICOM applications, while aiming to be fast, safe, and intuitive to use.
