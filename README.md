...
* [dicom-server](https://github.com/microsoft/dicom-server) ⭐ 512 | 🐛 18 | 🌐 C# | 📅 2026-08-27 - The Medical Imaging Server for DICOM is an open source DICOM server that is easily deployed on Azure.
...
* [SimpleITK](https://github.com/SimpleITK/SimpleITK) ⭐ 1,083 | 🐛 103 | 🌐 C++ | 📅 2026-08-28 - A simplified interface for the Insight Toolkit [ITK](https://itk.org/) with several components supporting general filtering operations, image segmentation, and registration.
...
* [dcm2niix](https://github.com/rordenlab/dcm2niix) ⭐ 1,183 | 🐛 3 | 🌐 C++ | 📅 2026-08-25 - Convert neuroimaging data from the DICOM format to the [NIfTI](https://nifti.nimh.nih.gov/) format.
...
* [dcm4che](https://github.com/dcm4che/dcm4che) ⭐ 1,453 | 🐛 163 | 🌐 Java | 📅 2026-08-24 - A collection of open source applications and utilities for the healthcare enterprise.
...
* [Weasis](https://github.com/nroduit/Weasis) ⭐ 1,318 | 🐛 36 | 🌐 Java | 📅 2026-08-26 - A multipurpose standalone and web-based DICOM viewer with a highly modular architecture.
...
* [Viewers](https://github.com/OHIF/Viewers) ⭐ 4,311 | 🐛 543 | 🌐 TypeScript | 📅 2026-08-28 - A zero-footprint medical image viewer provided by the [Open Health Imaging Foundation (OHIF)](https://ohif.org/). It is a configurable and extensible progressive web application with out-of-the-box support for image archives which support DICOMWeb.
...
* [VolView](https://github.com/Kitware/VolView) ⭐ 297 | 🐛 89 | 🌐 TypeScript | 📅 2026-08-27 - Web based radiological viewer for clinical professionals. Built with [Vue.js](https://vuejs.org/) and [VTK.js](https://github.com/Kitware/vtk-js) ⭐ 1,524 | 🐛 293 | 🌐 JavaScript | 📅 2026-08-27.
...
* [pydicom](https://github.com/pydicom/pydicom) ⭐ 2,199 | 🐛 40 | 🌐 Python | 📅 2026-08-03 - A pure Python package for working with DICOM files. It lets you read, modify and write DICOM data in an easy "pythonic" way.
