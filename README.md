...
* [dicom-server](https://github.com/microsoft/dicom-server) ⭐ 513 | 🐛 18 | 🌐 C# | 📅 2026-09-03 - The Medical Imaging Server for DICOM is an open source DICOM server that is easily deployed on Azure.
...
* [SimpleITK](https://github.com/SimpleITK/SimpleITK) ⭐ 1,084 | 🐛 101 | 🌐 C++ | 📅 2026-09-03 - A simplified interface for the Insight Toolkit [ITK](https://itk.org/) with several components supporting general filtering operations, image segmentation, and registration.
...
* [Viewers](https://github.com/OHIF/Viewers) ⭐ 4,317 | 🐛 552 | 🌐 TypeScript | 📅 2026-09-03 - A zero-footprint medical image viewer provided by the [Open Health Imaging Foundation (OHIF)](https://ohif.org/). It is a configurable and extensible progressive web application with out-of-the-box support for image archives which support DICOMWeb.
* [DWV](https://github.com/ivmartel/dwv) ⭐ 1,848 | 🐛 44 | 🌐 JavaScript | 📅 2026-09-03 - DICOM Web Viewer (DWV) is an open source zero footprint medical image viewer library. It uses only JavaScript and HTML5 technologies, meaning that it can be run on any platform that provides a modern browser (laptop, tablet, phone and even modern TVs).
...
* [VolView](https://github.com/Kitware/VolView) ⭐ 299 | 🐛 93 | 🌐 TypeScript | 📅 2026-09-03 - Web based radiological viewer for clinical professionals. Built with [Vue.js](https://vuejs.org/) and [VTK.js](https://github.com/Kitware/vtk-js) ⭐ 1,526 | 🐛 299 | 🌐 JavaScript | 📅 2026-09-04.
...
* [dicom-microscopy-viewer](https://github.com/ImagingDataCommons/dicom-microscopy-viewer) ⭐ 129 | 🐛 17 | 🌐 JavaScript | 📅 2026-08-29 - Vanilla JS library for web-based visualization of DICOM VL Whole Slide Microscopy Image datasets and derived information.
...
* [pydicom](https://github.com/pydicom/pydicom) ⭐ 2,202 | 🐛 43 | 🌐 Python | 📅 2026-08-31 - A pure Python package for working with DICOM files. It lets you read, modify and write DICOM data in an easy "pythonic" way.
...
* [highdicom](https://github.com/ImagingDataCommons/highdicom) ⭐ 240 | 🐛 33 | 🌐 Python | 📅 2026-09-04 - Provides high-level DICOM abstractions for the Python programming language to facilitate the creation and handling of DICOM objects for image-derived information, including image annotations, and image analysis results.
...
* [dicom-anonymizer](https://github.com/KitwareMedical/dicom-anonymizer) ⭐ 144 | 🐛 8 | 🌐 Python | 📅 2026-07-10 - A tool for anonymizing DICOM files according to the DICOM standard.
