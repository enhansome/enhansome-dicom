...
* [fo-dicom](https://github.com/fo-dicom/fo-dicom) ⭐ 1,207 | 🐛 66 | 🌐 C# | 📅 2026-08-01 - Fellow Oak DICOM, a DICOM toolkit in C# for all .NET Standard 2.0 compatible frameworks.
* [dicom-server](https://github.com/microsoft/dicom-server) ⭐ 512 | 🐛 17 | 🌐 C# | 📅 2026-08-14 - The Medical Imaging Server for DICOM is an open source DICOM server that is easily deployed on Azure.
...
* [SimpleITK](https://github.com/SimpleITK/SimpleITK) ⭐ 1,083 | 🐛 96 | 🌐 C++ | 📅 2026-08-13 - A simplified interface for the Insight Toolkit [ITK](https://itk.org/) with several components supporting general filtering operations, image segmentation, and registration.
* [CTK](https://github.com/commontk/CTK) ⭐ 963 | 🐛 230 | 🌐 C++ | 📅 2026-08-12 - The Common Toolkit is a community effort to provide support code for medical image analysis, surgical navigation, and related projects.
* [DCMTK](https://github.com/DCMTK/dcmtk) ⭐ 899 | 🐛 15 | 🌐 C++ | 📅 2026-08-12 - The DICOM ToolKit (DCMTK) package consists of source code, documentation and installation instructions for a set of software libraries and applications implementing part of the DICOM/MEDICOM Standard.
...
* [dcmqi](https://github.com/QIICR/dcmqi) ⭐ 283 | 🐛 74 | 🌐 C++ | 📅 2026-08-11 - DICOM for Quantitative Imaging (dcmqi) is a collection of libraries and command line tools with minimum dependencies to support standardized communication of quantitative image analysis research data using the DICOM standard.
* [Orthanc](https://github.com/jodogne/OrthancMirror) ⭐ 41 | 🐛 0 | 🌐 C++ | 📅 2026-08-14 - A simple yet powerful standalone DICOM server. It is designed to improve the DICOM flows in hospitals and to support research about the automated analysis of medical images.

#### Conversion

* [dcm2niix](https://github.com/rordenlab/dcm2niix) ⭐ 1,181 | 🐛 4 | 🌐 C++ | 📅 2026-08-13 - Convert neuroimaging data from the DICOM format to the [NIfTI](https://nifti.nimh.nih.gov/) format.
...
* [DICOMautomaton](https://github.com/hdclark/DICOMautomaton) ⭐ 90 | 🐛 32 | 🌐 C++ | 📅 2026-07-08 - A multipurpose tool for analyzing medical physics data with a focus on automation.
...
* [dicom](https://github.com/suyashkumar/dicom) ⭐ 1,075 | 🐛 132 | 🌐 Go | 📅 2026-06-21 - High performance Golang DICOM parser.
...
* [Weasis](https://github.com/nroduit/Weasis) ⭐ 1,311 | 🐛 44 | 🌐 Java | 📅 2026-08-08 - A multipurpose standalone and web-based DICOM viewer with a highly modular architecture.
...
* [Viewers](https://github.com/OHIF/Viewers) ⭐ 4,291 | 🐛 538 | 🌐 TypeScript | 📅 2026-08-13 - A zero-footprint medical image viewer provided by the [Open Health Imaging Foundation (OHIF)](https://ohif.org/). It is a configurable and extensible progressive web application with out-of-the-box support for image archives which support DICOMWeb.
* [DWV](https://github.com/ivmartel/dwv) ⭐ 1,840 | 🐛 44 | 🌐 JavaScript | 📅 2026-08-07 - DICOM Web Viewer (DWV) is an open source zero footprint medical image viewer library. It uses only JavaScript and HTML5 technologies, meaning that it can be run on any platform that provides a modern browser (laptop, tablet, phone and even modern TVs).
...
* [VolView](https://github.com/Kitware/VolView) ⭐ 292 | 🐛 85 | 🌐 TypeScript | 📅 2026-08-07 - Web based radiological viewer for clinical professionals. Built with [Vue.js](https://vuejs.org/) and [VTK.js](https://github.com/Kitware/vtk-js) ⭐ 1,521 | 🐛 302 | 🌐 JavaScript | 📅 2026-08-11.
...
* [dicom-microscopy-viewer](https://github.com/ImagingDataCommons/dicom-microscopy-viewer) ⭐ 128 | 🐛 15 | 🌐 JavaScript | 📅 2026-08-12 - Vanilla JS library for web-based visualization of DICOM VL Whole Slide Microscopy Image datasets and derived information.
...
* [pydicom](https://github.com/pydicom/pydicom) ⭐ 2,193 | 🐛 34 | 🌐 Python | 📅 2026-08-03 - A pure Python package for working with DICOM files. It lets you read, modify and write DICOM data in an easy "pythonic" way.
...
* [highdicom](https://github.com/ImagingDataCommons/highdicom) ⭐ 238 | 🐛 34 | 🌐 Python | 📅 2026-08-07 - Provides high-level DICOM abstractions for the Python programming language to facilitate the creation and handling of DICOM objects for image-derived information, including image annotations, and image analysis results.
* [dicomweb-client](https://github.com/ImagingDataCommons/dicomweb-client) ⭐ 128 | 🐛 15 | 🌐 Python | 📅 2026-07-28 - Provides client interfaces for DICOMWeb RESTful services QIDO-RS, WADO-RS and STOW-RS to search, retrieve and store DICOM objects over the web, respectively.
...
* [heudiconv](https://github.com/nipy/heudiconv) ⭐ 283 | 🐛 216 | 🌐 Python | 📅 2026-08-10 - A flexible DICOM converter for organizing brain imaging data into structured directory layouts.
...
* [dcmrtstruct2nii](https://github.com/Sikerdebaard/dcmrtstruct2nii) ⭐ 104 | 🐛 9 | 🌐 Python | 📅 2024-02-28 - DICOM RT-Struct to nii-mask. This is a naïve approach to rasterizing rt-struct to masks in the NIfTI format.
* [dicom-numpy](https://github.com/innolitics/dicom-numpy) ⭐ 96 | 🐛 4 | 🌐 Python | 📅 2023-05-10 - A set of utilities for extracting data contained in DICOM files into Numpy ndarrays.
...
* [AlizaMS](https://github.com/AlizaMedicalImaging/AlizaMS) ⭐ 309 | 🐛 3 | 🌐 C++ | 📅 2026-08-13 - DICOM viewer.
