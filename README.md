...
* [SimpleITK](https://github.com/SimpleITK/SimpleITK) ⭐ 1,089 | 🐛 101 | 🌐 C++ | 📅 2026-09-19 - A simplified interface for the Insight Toolkit [ITK](https://itk.org/) with several components supporting general filtering operations, image segmentation, and registration.
...
* [Orthanc](https://github.com/jodogne/OrthancMirror) ⭐ 43 | 🐛 0 | 🌐 C++ | 📅 2026-09-26 - A simple yet powerful standalone DICOM server. It is designed to improve the DICOM flows in hospitals and to support research about the automated analysis of medical images.
...
* [Weasis](https://github.com/nroduit/Weasis) ⭐ 1,337 | 🐛 43 | 🌐 Java | 📅 2026-09-13 - A multipurpose standalone and web-based DICOM viewer with a highly modular architecture.

### JavaScript

#### General

* [dcmjs](https://github.com/dcmjs-org/dcmjs) ⭐ 350 | 🐛 133 | 🌐 JavaScript | 📅 2026-09-22 - JavaScript implementation of DICOM manipulation. This code is an outgrowth of several efforts to implement web applications for medical imaging.
...
* [Viewers](https://github.com/OHIF/Viewers) ⭐ 4,349 | 🐛 574 | 🌐 TypeScript | 📅 2026-09-25 - A zero-footprint medical image viewer provided by the [Open Health Imaging Foundation (OHIF)](https://ohif.org/). It is a configurable and extensible progressive web application with out-of-the-box support for image archives which support DICOMWeb.
* [DWV](https://github.com/ivmartel/dwv) ⭐ 1,846 | 🐛 44 | 🌐 JavaScript | 📅 2026-09-25 - DICOM Web Viewer (DWV) is an open source zero footprint medical image viewer library. It uses only JavaScript and HTML5 technologies, meaning that it can be run on any platform that provides a modern browser (laptop, tablet, phone and even modern TVs).
...
* [VolView](https://github.com/Kitware/VolView) ⭐ 304 | 🐛 93 | 🌐 TypeScript | 📅 2026-09-25 - Web based radiological viewer for clinical professionals. Built with [Vue.js](https://vuejs.org/) and [VTK.js](https://github.com/Kitware/vtk-js) ⭐ 1,532 | 🐛 297 | 🌐 JavaScript | 📅 2026-09-23.
...
* [dicom-microscopy-viewer](https://github.com/ImagingDataCommons/dicom-microscopy-viewer) ⭐ 129 | 🐛 19 | 🌐 JavaScript | 📅 2026-09-25 - Vanilla JS library for web-based visualization of DICOM VL Whole Slide Microscopy Image datasets and derived information.
...
* [highdicom](https://github.com/ImagingDataCommons/highdicom) ⭐ 241 | 🐛 38 | 🌐 Python | 📅 2026-09-24 - Provides high-level DICOM abstractions for the Python programming language to facilitate the creation and handling of DICOM objects for image-derived information, including image annotations, and image analysis results.
...
* [heudiconv](https://github.com/nipy/heudiconv) ⭐ 284 | 🐛 219 | 🌐 Python | 📅 2026-09-26 - A flexible DICOM converter for organizing brain imaging data into structured directory layouts.
