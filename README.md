...
* [dicom-server](https://github.com/microsoft/dicom-server) ⭐ 512 | 🐛 17 | 🌐 C# | 📅 2026-08-19 - The Medical Imaging Server for DICOM is an open source DICOM server that is easily deployed on Azure.
...
* [SimpleITK](https://github.com/SimpleITK/SimpleITK) ⭐ 1,081 | 🐛 98 | 🌐 C++ | 📅 2026-08-22 - A simplified interface for the Insight Toolkit [ITK](https://itk.org/) with several components supporting general filtering operations, image segmentation, and registration.
...
* [Weasis](https://github.com/nroduit/Weasis) ⭐ 1,314 | 🐛 45 | 🌐 Java | 📅 2026-08-15 - A multipurpose standalone and web-based DICOM viewer with a highly modular architecture.
...
* [NiiVue](https://github.com/niivue/niivue) ⭐ 480 | 🐛 28 | 🌐 TypeScript | 📅 2026-08-18 - A WebGL module that can be embedded into HTML, Vue.js, Angular, React, Electron and Capacitor frameworks. It provides scripting and drag and drop abilities to visualize and render voxel-based images (e.g., DICOM and NIfTI), meshes, and tractography streamlines and connectomes, as well as drawing functions ([demos](https://niivue.github.io/niivue/)).
...
* [bluelight](https://github.com/cylab-tw/bluelight) ⭐ 156 | 🐛 1 | 🌐 JavaScript | 📅 2026-08-19 - Browser-based medical image viewer primarily maintained by the [Imaging Informatics Labs](https://cylab.dicom.tw/). It is a pure single-page application (SPA), lightweight, and using only JavaScript and HTML5 technologies to easily deploy it on any HTTP server.
...
* [pydicom](https://github.com/pydicom/pydicom) ⭐ 2,196 | 🐛 38 | 🌐 Python | 📅 2026-08-03 - A pure Python package for working with DICOM files. It lets you read, modify and write DICOM data in an easy "pythonic" way.
...
* [highdicom](https://github.com/ImagingDataCommons/highdicom) ⭐ 239 | 🐛 34 | 🌐 Python | 📅 2026-08-22 - Provides high-level DICOM abstractions for the Python programming language to facilitate the creation and handling of DICOM objects for image-derived information, including image annotations, and image analysis results.
