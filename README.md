...
* [SimpleITK](https://github.com/SimpleITK/SimpleITK) ⭐ 1,081 | 🐛 99 | 🌐 C++ | 📅 2026-08-20 - A simplified interface for the Insight Toolkit [ITK](https://itk.org/) with several components supporting general filtering operations, image segmentation, and registration.
...
* [MITK](https://github.com/MITK/MITK) ⭐ 834 | 🐛 0 | 🌐 C++ | 📅 2026-08-21 - The Medical Imaging Interaction Toolkit (MITK) is a free open-source software system for development of interactive medical image processing software. MITK combines the Insight Toolkit (ITK) and the Visualization Toolkit (VTK) with an application framework.
* [GDCM](https://github.com/malaterre/GDCM) ⭐ 398 | 🐛 3 | 🌐 C++ | 📅 2026-08-21 - Grassroots DICOM (GDCM) is an implementation of the DICOM standard designed to be open source, so that researchers may access clinical data directly. GDCM includes a file format definition and a network communications protocol, both of which should be extended to provide a full set of tools for a researcher or small medical imaging vendor to interface with an existing medical database.
...
* [dcm4che](https://github.com/dcm4che/dcm4che) ⭐ 1,449 | 🐛 162 | 🌐 Java | 📅 2026-08-19 - A collection of open source applications and utilities for the healthcare enterprise.
...
* [Weasis](https://github.com/nroduit/Weasis) ⭐ 1,313 | 🐛 42 | 🌐 Java | 📅 2026-08-15 - A multipurpose standalone and web-based DICOM viewer with a highly modular architecture.
...
* [bluelight](https://github.com/cylab-tw/bluelight) ⭐ 155 | 🐛 1 | 🌐 JavaScript | 📅 2026-08-19 - Browser-based medical image viewer primarily maintained by the [Imaging Informatics Labs](https://cylab.dicom.tw/). It is a pure single-page application (SPA), lightweight, and using only JavaScript and HTML5 technologies to easily deploy it on any HTTP server.
...
* [pydicom](https://github.com/pydicom/pydicom) ⭐ 2,195 | 🐛 38 | 🌐 Python | 📅 2026-08-03 - A pure Python package for working with DICOM files. It lets you read, modify and write DICOM data in an easy "pythonic" way.
